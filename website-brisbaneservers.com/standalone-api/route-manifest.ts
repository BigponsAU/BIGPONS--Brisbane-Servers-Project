...
export const standaloneApiRoutes: RouteDefinition[] = [
  ...
  { path: '/api/documents/extract', loadModule: () => import('../src/pages/_api/documents/extract') },
  { path: '/api/documents/rewrite', loadModule: () => import('../src/pages/_api/documents/rewrite') },
  { path: '/api/documents/costs', loadModule: () => import('../src/pages/_api/documents/costs') },
